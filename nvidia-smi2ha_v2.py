...
USERNAME = os.environ.get('MQTT_USERNAME', 'LOGIN')
PASSWORD = os.environ.get('MQTT_PASSWORD', 'PASS')
...
#    client = mqtt.Client(client_id="nvidia-ha-reporter")
    client = mqtt.Client(client_id="nvidia-ha-reporter", callback_api_version=mqtt.CallbackAPIVersion.VERSION1)
